...
import com.astgo.fenxiao.fragment.ShoppingFragment;
...
public class MyWebChromeClient extends WebChromeClient {
    ...
    public MyWebChromeClient(IWebPageView mIWebPageView) {
        ...
        if(mFragment instanceof ShoppingFragment){
            this.mFragment = (ShoppingFragment) mIWebPageView;
        }

        if(taoWebviewActivity instanceof TaoWebviewActivity){
            this.taoWebviewActivity = (TaoWebviewActivity) mIWebPageView;
        }
    }
    ...
    public void onShowCustomView(View view, CustomViewCallback callback) {
        mFragment.getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    ...
    public void onHideCustomView() {
        if (mXCustomView == null)// 不是全屏播放状态
            return;
        mFragment.getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    private void openFileChooserImpl(ValueCallback<Uri> uploadMsg) {
        ...
        i.setType("image/*");
        mFragment.getActivity().startActivityForResult(Intent.createChooser(i, "文件选择"), FILECHOOSER_RESULTCODE);
    }
    ...
    private void openFileChooserImplForAndroid5(ValueCallback<Uri[]> uploadMsg) {
        ...
        mFragment.getActivity().startActivityForResult(chooserIntent, FILECHOOSER_RESULTCODE_FOR_ANDROID_5);
    }
