package com.astgo.fenxiao.JPush;
...
import com.astgo.fenxiao.tools.MAppUtils;
        ...
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                if (MAppUtils.getAppSatus(context, context.getPackageName()) == 3 ||
                        !com.astgo.fenxiao.tools.utils.SPUtils.getBoolean(MyConstant.SP_LOGIN_STATE, false)) {//应该不存在这种情况以防万一
