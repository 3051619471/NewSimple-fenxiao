 ...
 */
//全部
public class Whale_Fragment extends Fragment {
    private View view;
    private XRecyclerView mVideoWhale;
private String path;
...
private Handler handler=new Handler(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //视频
        path = ip_url +"index.php?s=/Home/study/studyResource&id=34&uid="+uid;
        initResource();
        return view;
    }
    ...
    private void initView(View view) {
        mVideoWhale = (XRecyclerView) view.findViewById(R.id.video_whale);
    }
}
