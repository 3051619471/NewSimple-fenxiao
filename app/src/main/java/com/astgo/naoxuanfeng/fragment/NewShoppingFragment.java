...
import com.astgo.naoxuanfeng.adapter.MyFragmentPagerAdapter;
...
import com.astgo.naoxuanfeng.bean.ShopBannerInfor;
import com.astgo.naoxuanfeng.fragment.shopcommodity.CommodityXiaoLiangFragment;
import com.astgo.naoxuanfeng.fragment.shopcommodity.CommodityXinPinFragment;
import com.astgo.naoxuanfeng.fragment.shopcommodity.CommodityZongHeFragment;
import com.astgo.naoxuanfeng.glide.GlideImageLoader;
import com.astgo.naoxuanfeng.http.service.HttpClient;
import com.astgo.naoxuanfeng.http.service.HttpShopResultSubscriber;
...
import com.astgo.naoxuanfeng.widget.RefreshHeader;
...
//    }
    ...
    private void initRecv(View view) {
        RecyclerView recvShopCategory = (RecyclerView) view.findViewById(R.id.shop_category_recycle);
        shopCategoryAdapter = new ShopCategoryAdapter(R.layout.shop_category_item,shopCategoryBeanList);
        GridLayoutManager gridLayoutManager = new GridLayoutManager (getActivity(),5);
        gridLayoutManager.setSmoothScrollbarEnabled(true);
        gridLayoutManager.setAutoMeasureEnabled(true);recvShopCategory.setLayoutManager(gridLayoutManager);
