package com.astgo.naoxuanfeng.fragment.shop;
...
import com.astgo.naoxuanfeng.adapter.CommodityAdapter;
import com.astgo.naoxuanfeng.adapter.ShopCategoryAdapter;
import com.astgo.naoxuanfeng.bean.BaseDataObject;
import com.astgo.naoxuanfeng.bean.CategoryBean;
import com.astgo.naoxuanfeng.bean.HomeColumnBean;
import com.astgo.naoxuanfeng.bean.NewBanner;
import com.astgo.naoxuanfeng.bean.ShopListBean;
import com.astgo.naoxuanfeng.classdomel.class_activity.Details_Shop_Activity;
import com.astgo.naoxuanfeng.classdomel.class_adapter.Shop_Adapter;
import com.astgo.naoxuanfeng.classdomel.class_bean.Shop_Bean;
import com.astgo.naoxuanfeng.classdomel.class_bean.Shop_Sudu_Bean;
...
import com.astgo.naoxuanfeng.minterface.EditTextChangeInterface;
import com.astgo.naoxuanfeng.tools.CommonAdapter;
import com.astgo.naoxuanfeng.tools.ViewHolder;
...
import com.astgo.naoxuanfeng.yunnaosudu.view.YunNao_Activity;
...
public class NestShoppingFragment extends BaseFragment implements View.OnClickListener {
    ...
    private String path_shop = IP_url+"index.php?s=/Home/study/studyCategory";
    private String path_sudu;
    ...
    public int[] imgTitles = new int[]{R.drawable.baomas_20181204172406, R.drawable.baomac_20181204172441, R.drawable.taobao, R.drawable.jifen, R.drawable.zixun, R.drawable.quanzi};
    //public String[] desList = new String[]{"爆款直降 低至2.5折", "优品大集合 带你逛不停", "优惠券抵扣 实惠多多", "积分！用心挑好物", "探索新奇特", "邂逅好物 发现理想生活"};
    public int[] desList = new int[]{R.drawable.tejiatu, R.drawable.jiamengtu, R.drawable.taobaotu, R.drawable.jifentu, R.drawable.zixuntu, R.drawable.quanzitu};

    private Intent intent;
    private RecyclerView shop_category_recycle;
    private int data_sudu;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            final List<Shop_Bean.DataBean> data = (List<Shop_Bean.DataBean>) msg.obj;
            Shop_Adapter shop_adapter = new Shop_Adapter(data, getActivity());
            shop_category_recycle.setAdapter(shop_adapter);
            shop_category_recycle.setLayoutManager(new GridLayoutManager(getActivity(), 3));
            shop_adapter.setOnItemClickListenerShop(new Shop_Adapter.OnItemClickListenerShop() {
                @Override
                public void onClick(int position, String id, String name) {
                    if (position == 0 || position == 1 || position == 2 || position == 4) {
                        Intent intent = new Intent(getActivity(), Details_Shop_Activity.class);
                      //  String id_banner = data.get(position).getId();
                        SharedPreferences pref = getActivity().getSharedPreferences("id_banner",MODE_PRIVATE);
                       ...
                       // Toast.makeText(getActivity(), id+"", Toast.LENGTH_SHORT).show();
                        ...
                        if (data_sudu==1){
                            Intent intent = new Intent(getActivity(), YunNao_Activity.class);
                            startActivity(intent);
                        }else {
                            Toast.makeText(getActivity(), "您好，您不是会员，请开通会员", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        path_sudu = IP_url+"http://nxf.dykj168.com/index.php?s=/Home/study/estimateLavel&uid="+uid;
        initshop();
        init_sudu();
    }
//云脑速度
    private void init_sudu() {
        OkhttpUtils getshu = OkhttpUtils.getshu();
        getshu.say(path_sudu, new OkhttpUtils.fun1() {

            @Override
            public void onres(String string) {
                Gson gson = new Gson();
                Shop_Sudu_Bean shop_sudu_bean = gson.fromJson(string, Shop_Sudu_Bean.class);
                data_sudu = shop_sudu_bean.getData();
            }
        });
    }
    ...
    private void initshop() {
        ...
        getshu.say(path_shop, new OkhttpUtils.fun1() {
            ...
            public void onres(String string) {
                Gson gson = new Gson();
                Shop_Bean shop_bean = gson.fromJson(string, Shop_Bean.class);
                List<Shop_Bean.DataBean> data = shop_bean.getData();
    ...
    private void initRecv(View view) {
        ...
        adapterColumn = new CommonRCAdapter<HomeColumnBean>(getActivity(), homeColumnBeanList, R.layout.item_column) {
            ...
            public void convert(CommonRCViewHolder holder, int position, HomeColumnBean homeColumnBean) {
                ...
                holder.setImage(R.id.img_des, homeColumnBean.des);
...
//        });
    ...
    private void initHeaderView(View headerView) {
        shop_category_recycle = (RecyclerView) headerView.findViewById(R.id.shop_category_recycle);
