package com.astgo.naoxuanfeng.tts.util;
...
public class FileUtil {
    public static final String sampleDir = "TTS";
    public static String tmpDir = Environment.getExternalStorageDirectory().toString() + "/" + sampleDir;
