...
public class SipEngineCoreImpl implements SipEngineCore {
	...
	private native boolean RegisterSipAccount(long nativePtr, String username,
			String password, String server, int port);
	...
	private native boolean SetRC4Crypt(long nativePtr, boolean yesno, String key);
	...
	private native boolean SetNetworkStateReachable(long nativePtr,
			boolean yesno);
	...
	private native boolean SetTurnServer(long nativePtr, String user,
			String passwd, String turn_server);
	...
	public boolean RegisterSipAccount(String username, String password,
		...
		return RegisterSipAccount(nativePtr, username, password, server, port);
	}
	...
	public boolean SetRC4Crypt(boolean yesno, String key) {
		return SetRC4Crypt(nativePtr, yesno, key);
	}
